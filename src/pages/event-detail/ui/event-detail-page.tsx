...
export function EventDetailPage() {
  ...
  return (
    <div>
      {/* Hero */}
      <div className="relative flex h-[208px] items-end" style={{ background: coverBackground(event.coverSeed) }}>
        ...
        <div className="relative mx-auto w-full max-w-[1500px] px-[34px] pb-5.5" style={{ paddingBottom: 22 }}>
          ...
          <div className="flex flex-wrap items-end justify-between gap-5">
            <div>
              ...
              <h1 className="text-[30px] font-semibold tracking-[-0.025em]">{event.name}</h1>
      ...
      <div className="mx-auto max-w-[1500px] px-[34px] pb-16 pt-6">
        ...
        {tab === 'media' && <MediaTab eventId={event.id} />}
