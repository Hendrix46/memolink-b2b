  ...
  return (
    <section className="mb-6">
      ...
      <div className="grid gap-4 [grid-template-columns:repeat(auto-fill,minmax(300px,1fr))]">
        {events.map((e) => {
          const cd = countdown(e.countdownDays);
          const ratio = e.cap > 0 ? e.going / e.cap : 0;
          return (
            <button
              key={e.eventId}
              onClick={() => navigate(paths.event(e.eventId))}
            ...
            >
              <div className="relative h-[118px]" style={{ background: coverFrom(e.coverPhotoUrl, e.eventId) }}>
